...
INSTRUCTION_MAP = {
	...
	"B2F": (0x2, 0x0000, 0x0001, 0, False),
	"I2B": (0x2, 0x0000, 0x0002, 0, False),
	"F2B": (0x2, 0x0000, 0x0002, 0, False),
	...
	"JUMPIND": (0x4, 0x0003, 0x0000, 0, False),
	"CALL": (0x4, 0x0004, 0x0000, 1, False),
	"CALZ": (0x4, 0x0005, 0x0000, 1, False),
	"CALN": (0x4, 0x0006, 0x0000, 1, False),
	"CALLIND": (0x4, 0x0007, 0x0000, 0, False),
	"RET": (0x4, 0x0008, 0x0000, 0, False),
	"RETZ": (0x4, 0x0009, 0x0000, 0, False),
	"RETN": (0x4, 0x000A, 0x0000, 0, False),
