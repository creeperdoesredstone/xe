...
INSTRUCTION_MAP = {
	...
	"JUMP":      (0x4, 0x0000, 0x0000, 1, True),
	"BRZ":       (0x4, 0x0001, 0x0000, 1, True),
	"BRNZ":      (0x4, 0x0002, 0x0000, 1, True),
	"CALL":      (0x4, 0x0003, 0x0000, 1, True),
	"CALZ":      (0x4, 0x0004, 0x0000, 1, True),
	"CALN":      (0x4, 0x0005, 0x0000, 1, True),
	...
	"OFFSET":    (0x8, 0x0002, 0x0000, 1, False),
	"LOADOFF":   (0x8, 0x0003, 0x0000, 1, False),
	"LOADINOFF": (0x8, 0x0004, 0x0000, 0, False),
	"PUSHOFF":   (0x8, 0x0005, 0x0000, 0, False),
	"POPOFF":    (0x8, 0x0006, 0x0000, 0, False),
	"ENABOFF":   (0x8, 0x0007, 0x0000, 0, False),
	"DISABOFF":  (0x8, 0x0008, 0x0000, 0, False),
}
